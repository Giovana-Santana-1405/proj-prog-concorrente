...
def main():
    ...
    # CONFIGURAÇÃO ALTERADA PARA 8 THREADS
    qtd_threads = 8 
    ...
    with open("US_Accidents_March23.csv", "r", encoding="utf-8") as arquivo:
        ...
        with ProcessPoolExecutor(max_workers=qtd_threads) as executor:
            ...
            # Aumentamos o lote para que cada uma das 8 threads pegue 100 mil linhas por vez
            TAMANHO_LOTE = 800000  
            ...
            for linha in leitor:
                ...
                # Quando o lote acumular linhas suficientes para as 8 threads
                if len(linhas_temporarias) >= TAMANHO_LOTE:
                    lotes_enviados += 1
                    
                    # Calcula o tamanho de cada fatia (1/8 do lote)
                    ...
                    # Divide o lote em 8 partes e dispara as 8 threads
